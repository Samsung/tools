...
async function downloadSamsungCertfile(rootURL, destDir) {
    console.info(moduleName + 'downloadManager.downloadSamsungCertfile start');
    let samsungCertExtensionUrl = await getExtensionPkgInfo(rootURL + '/extension_info.xml', 'Samsung Certificate Extension');
